...
Курсовая работа: «Естественный язык как целое». Целевой язык — **мальтийский (mt)**. Дедлайн: ~2026-06-02 (12 дней с 2026-05-21).

Лаборатория проекта: В. А. Громов, ВШЭ. Методичка — `docs/notion-export/`.
